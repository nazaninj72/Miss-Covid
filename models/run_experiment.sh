...
mkdir /home/nazaninjafar/ds4cg2020/UMassDS/DS4CG2020-aucode/exp{job_id}
...
python main.py \
  "${BASE_PARAMS[@]}"\
 --learningrate 5e-5 >  /home/nazaninjafar/ds4cg2020/UMassDS/DS4CG2020-aucode/experiments/exp{job_id}/log.txt
