...
import csv
tweets=read_csv('data/potential_misinformation.csv')
#print(len(tweets))
...
def transformer(model_name, train_df, eval_df, epochs, labels):
...
model, result, model_outputs, wrong_predictions = transformer('bert', train_df, eval_df, 7, 5)
...
def read_csv_category(csv_file,category):
    with open(csv_file, mode='r', encoding='utf-8') as file:
        ...
        stored_claims=[]
        for row in csv_reader:
            if row['Class'].lower() == category.lower():
                stored_claims.append((row['Claim Text'], row['Value']))
    random.shuffle(stored_claims)
    return stored_claims
...
model, result, model_outputs, wrong_predictions = transformer('bert', train_df, eval_df, 8, 5)
...
with open('data/topics/politics.tsv', mode='w', encoding='utf-8', newline='') as file:
        writer = csv.writer(file, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)
...
with open('data/topics/other.tsv', mode='w', encoding='utf-8', newline='') as file:
        writer = csv.writer(file, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)
        writer.writerow(['Tweet id', 'Tweet text', 'True/False?'])
        for tweet in other:
            writer.writerow([str(tweet[0]),tweet[1],tweet[2]])
...
with open('data/topics/health.tsv', mode='w', encoding='utf-8', newline='') as file:
        writer = csv.writer(file, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)
        writer.writerow(['Tweet id', 'Tweet text', 'True/False?'])
        for tweet in health:
            writer.writerow([str(tweet[0]),tweet[1],tweet[2]])
...
with open('data/topics/transmission.tsv', mode='w', encoding='utf-8', newline='') as file:
        writer = csv.writer(file, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)
        writer.writerow(['Tweet id', 'Tweet text', 'True/False?'])
...
with open('data/topics/immunity.tsv', mode='w', encoding='utf-8', newline='') as file:
        writer = csv.writer(file, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)
        writer.writerow(['Tweet id', 'Tweet text', 'True/False?'])
